# This Makefile is for the LarkSonar extension to perl.
#
...
#     ABSTRACT => q[perfSONAR client library abstraction layer for the NSF lark project]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[LarkSonar]
#     PREREQ_PM => { XML::DOM=>q[0], XML::Twig=>q[0], Data::Dumper=>q[0], XML::LibXML=>q[0], perfSONAR_PS=>q[0], Exporter=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[3.1]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/LarkSonar/Common.pm
...
TO_INST_PM = lib/LarkSonar/Common.pm

PM_TO_BLIB = lib/LarkSonar/Common.pm \
	blib/lib/LarkSonar/Common.pm
...
manifypods : pure_all  \
	lib/LarkSonar/Common.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/LarkSonar/Common.pm $(INST_MAN3DIR)/LarkSonar::Common.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''perfSONAR client library abstraction layer for the NSF lark project'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: LarkSonar' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  XML::DOM: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  XML::LibXML: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  XML::Twig: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  perfSONAR_PS: 0' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: 3.1' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "perfSONAR client library abstraction layer for the NSF lark project",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "LarkSonar",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "XML::DOM" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "XML::LibXML" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "XML::Twig" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "perfSONAR_PS" : 0' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "release_status" : "stable",' >> META_new.json
	$(NOECHO) $(ECHO) '   "version" : "3.1"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>perfSONAR client library abstraction layer for the NSF lark project</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR></AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Data::Dumper" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Exporter::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="XML::DOM" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="XML::LibXML" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="XML::Twig" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="perfSONAR_PS::" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/LarkSonar/Common.pm blib/lib/LarkSonar/Common.pm 
